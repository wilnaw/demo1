...
(function(m, b, w) {
        ...
        if (null != menusToCombine) {
            var d = menusToCombine[0],
                c = b(menusToCombine).filter(function(a) {
                    if (0 < a) return a });
            "none" !== k(a) ? (b.each(c, function(a, c) { b(c).find(".menu > li").addClass("moved-item-" + c.replace(".", "")).appendTo(d + " ul.genesis-nav-menu") }), b(g(c)).hide()) : (b(g(c)).show(), b.each(c, function(a, c) {
                b(".moved-item-" +
    ...
    function p(a) {
        ...
        0 < !b(d).length || b.each(d, function(c, d) {
            var e = d.replace(".", ""),
                f = "genesis-" + e,
                g = "genesis-mobile-" + e; "none" == k(a) && (f = "genesis-mobile-" + e, g = "genesis-" + e);
    ...
    function k(a) { a = m.getElementById(a);
    ...
    function l() {
        var a = [];
        null !== menusToCombine && b.each(menusToCombine, function(b, c) { a.push(c.valueOf()) });
        b.each(genesisMenus.others, function(b, c) { a.push(c.valueOf()) });
    ...
    b.each(genesisMenusUnchecked, function(a) {
        ...
        b.each(this, function(d, c) {
            ...
            1 < f.length ? b.each(f, function(d, f) {
                    ...
                    genesisMenus[a].push(e); "combine" === a && menusToCombine.push(e) }) :
        ...
        init: function() {
            if (0 != b(l()).length) {
                var a = "undefined" !== typeof genesisMenuParams.menuIconClass ? genesisMenuParams.menuIconClass : "dashicons-before dashicons-menu",
                    ...
                    c = b("<button />", { "class": "menu-toggle", "aria-expanded": !1, "aria-pressed": !1, role: "button" }).append(genesisMenuParams.mainMenu),
                    f = b("<button />", { "class": "sub-menu-toggle", "aria-expanded": !1, "aria-pressed": !1, role: "button" }).append(b("<span />", { "class": "screen-reader-text", text: genesisMenuParams.subMenu }));
    ...
    b(m).ready(function() { null !== l() && v.init() })
})(document, jQuery);
